...
python -m pip install -r core-release-5.3.1/daemon/requirements.txt

# URLs to download core
COREPKG=https://github.com/coreemu/core/releases/download/release-5.3.1/core_python_5.3.1_amd64.deb
wget -c $COREPKG
apt -f -y install ./core_python_5.3.1_amd64.deb
